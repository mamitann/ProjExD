...
def main():
    ...
    while (1):
        ...
        screen.blit(font.render(str(score1), True,(255,255,255)),(250.,30.))
        screen.blit(font.render(str(score2), True,(255,255,255)),(400.,30.))
        ...
        # 得点の計算
        score1, score2, set1, set2 = calc_score(ball_x, score1, score2, set1, set2, circle_lst, ct_cir_xy, screen)
